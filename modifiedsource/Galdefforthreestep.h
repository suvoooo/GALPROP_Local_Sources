...
class Galdef {
 ...
 public:
  ...
  double z_step1;                        // height over which we apply D_xx*2 SB20170323
  double z_step2;                        // D_xx*4
  double z_step3;                        // D_xx*8   
  ...
  double D_fact;                        // multiplication factor in D0_xx over z_step
