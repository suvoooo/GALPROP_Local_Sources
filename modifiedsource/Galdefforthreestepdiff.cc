...
int Galdef::read ( const string& theVersion,
    ...
    strcpy (parstring,                                "z_step1" ); //SB20170323
    stat = read_galdef_parameter (filename,parstring,&z_step1);
    strcpy (parstring,                                "z_step2" ); //SB20170403
    stat = read_galdef_parameter (filename,parstring,&z_step2);	
    strcpy (parstring,                                "z_step3" ); //SB20170403
    stat = read_galdef_parameter (filename,parstring,&z_step3);
    //x-grid
...
void Galdef::print() {
    ...
    cout<<"  z_step1   "<<z_step1  <<endl;  // SB20170323
    cout<<"  z_step2   "<<z_step2  <<endl;  // SB20170403
    cout<<"  z_step3   "<<z_step3  <<endl;  // SB20170403
    cout<<"  dz       "<<dz      <<endl;
    ...
    cout<<"  D_fact      "<<D_fact        <<endl; //SB20170323
