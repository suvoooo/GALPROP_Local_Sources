	 ...
	 if(n_spatial_dimensions==3)
	   {
	     //particle.Dxx.d3[ix][iy][iz].s[ip] = particle.beta[ip] *galdef.D0_xx;
             if (abs(galaxy.z[iz]) > galdef.z_step3) { 
              particle.Dxx.d3[ix][iy][iz].s[ip] =  particle.beta[ip]*galdef.D0_xx*galdef.D_fact*8;//SB20170323	
	      if(galdef.diff_reacc<0) particle.Dxx.d3[ix][iy][iz].s[ip] = pow(particle.beta[ip],galdef.diff_reacc) *galdef.D0_xx*galdef.D_fact*8;
	      //cout<<"Now Z3 and D3"<<galaxy.z[iz]<<""<<particle.Dxx.d3[ix][iy][iz].s[ip]<<endl; 
	     ...
	     if (abs(galaxy.z[iz]) > galdef.z_step2) { 
              particle.Dxx.d3[ix][iy][iz].s[ip] =  particle.beta[ip]*galdef.D0_xx*galdef.D_fact*4;//SB20170403	
	      if(galdef.diff_reacc<0) particle.Dxx.d3[ix][iy][iz].s[ip] = pow(particle.beta[ip],galdef.diff_reacc) *galdef.D0_xx*galdef.D_fact*4;
	     ...
	     if (abs(galaxy.z[iz]) > galdef.z_step1) { 
              particle.Dxx.d3[ix][iy][iz].s[ip] =  particle.beta[ip]*galdef.D0_xx*galdef.D_fact*2;//SB20170403	
	      if(galdef.diff_reacc<0) particle.Dxx.d3[ix][iy][iz].s[ip] = pow(particle.beta[ip],galdef.diff_reacc) *galdef.D0_xx*galdef.D_fact*2;
	      //cout<<"Now Z1 and D1"<<galaxy.z[iz]<<""<<particle.Dxx.d3[ix][iy][iz].s[ip]<<endl; 
	      //cout<<"Now Diff:"<<galdef.D0_xx<<endl;
             }else {	
