	  ...
	  for (ip = 0; ip < particle.n_pgrid; ++ip) {
	   ...
	   if (highindex_z > particle.n_zgrid-1)  highindex_z = particle.n_zgrid-1;  	 
	    ...
	    alpha1_y.d3[ix][iy][iz].s[ip]
	      = particle.Dxx.d3[ix][iy][iz].s[ip]*pow(particle.dy, -2.) - (particle.Dxx.d3[ix][highindex_y][iz].s[ip]-particle.Dxx.d3[ix][lowindex_y][iz].s[ip])/4.*pow(particle.dy, -2.);
              
	    alpha1_z.d3[ix][iy][iz].s[ip]
	      = particle.Dxx.d3[ix][iy][iz].s[ip]*pow(particle.dz, -2.)-(particle.Dxx.d3[ix][iy][highindex_z].s[ip]-particle.Dxx.d3[ix][iy][lowindex_z].s[ip])/4.*pow(particle.dz, -2.);
//   alpha 2  
