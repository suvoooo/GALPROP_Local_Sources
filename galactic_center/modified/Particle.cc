...
int Particle::delete_transport_arrays()
{
   ...
   galac_source_function.delete_array();//SB2018Dec10th
...
int Particle::create_transport_arrays()
{
   ...
   if(n_spatial_dimensions==3)
   {
      ...
      galac_source_function      .init(n_xgrid, n_ygrid, n_zgrid, n_pgrid);//SB2018Dec10th 
...
Particle::Particle(const Particle &particle)
{
   ...
   galac_source_function   = particle.galac_source_function;//SB2018Dec10th 
