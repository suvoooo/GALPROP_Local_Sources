...
int Galdef::read ( const string& theVersion,
    ...
    strcpy(parstring,                             "near_distance2"          ); //SB/
    stat= read_galdef_parameter(filename,parstring,&near_distance2          ); //SB/
...
// DM: IMOS20050912
    ...
    cout<<"  near_distance3   "<< near_distance3  <<endl; //SB/
    cout<<"  near_distance4   "<< near_distance4  <<endl; //SB/
