...
// DM decay species: IMOS20050912
   ...
   if(galdef.primary_HNR_proton)    n_species++; // sb 2020/2/1
...
// primary HNR Protons SB 2020/02/01
   if (galdef.primary_HNR_proton)
   {
      strcpy(name, "primary_HNR_proton");
      Z=1;
      A=1; 
      t_half[0] = 0.;
      ...
      gcr[i].print();
      cout<<" ======== completed creation of of " << gcr[i].name<<endl 
         <<endl; 
      i++;                  
