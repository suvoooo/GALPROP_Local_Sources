...
int Galdef::read ( const string& theVersion,
    ...
    // CR species HNR Protons to include //SB 2020/03/1
    strcpy(parstring,                                "primary_HNR_proton" );
    stat = read_galdef_parameter( filename,parstring, &primary_HNR_proton );
    strcpy(parstring,                                "HNR_filename");
    stat = read_galdef_parameter (filename, parstring, HNR_filename); 
...
// DM: IMOS20050912
    ...
    // primary_HNR_proton  SB 2020/03/01
    cout<<"  primary_HNR_proton   "<<primary_HNR_proton  <<endl;
    cout<<"  HNR_filename         "<<HNR_filename <<endl; 
...
//  g.isotopic_abundance[2][4]= 7.199e+04;
    ...
    g.verbose              = 0;
    g.test_suite           = 0;
    //add the HNR part SB 2020/03/01

    g.primary_HNR_proton   = 1; // 1 compute the proton propagation 
    strcpy ( g.HNR_filename," ");
